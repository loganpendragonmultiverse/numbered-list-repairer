...
from numbered_list_repairer.cli import main
from numbered_list_repairer.core import PROJECT, analyze, render_json, render_markdown
...
def test_representative_sample_has_expected_result():
    ...
    assert report["items"] == 4 and report["text"].splitlines()[1] == "2. Second"
